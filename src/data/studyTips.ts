...
export const studyTips: StudyTip[] = [
  {
    ...
    readTime: "6 min",
    summary: "Part-by-part tactics for Photographs, Question–Response, Conversations, and Short Talks — including what to do in the seconds before the audio starts.",
    sections: [
      { heading: "Part 1 — Photographs (6 questions)", points: [
      ...
      { heading: "Part 2 — Question–Response (25 questions)", points: [
      ...
      { heading: "Part 3 — Conversations (39 questions)", points: [
      ...
      { heading: "Part 4 — Short Talks (30 questions)", points: [
      ...
      { heading: "The 8-second habit", body: "While the directions for each part are read aloud, you already know them — use that time to preview questions ahead. Never listen to the directions; read forward instead. This single habit is worth several points across the section." },
    ],
  },
  {
    ...
    category: "Listening & Reading",
    readTime: "6 min",
    summary: "How to handle grammar questions in seconds, manage text completion, and survive the long double- and triple-passage sets in Part 7.",
    sections: [
      { heading: "Part 5 — Incomplete Sentences (30 questions)", points: [
      ...
      { heading: "Part 6 — Text Completion (16 questions)", points: [
      ...
      { heading: "Part 7 — Reading Comprehension (54 questions)", points: [
      ...
      { heading: "If you're running out of time", body: "Never leave blanks — there's no penalty for wrong answers on the TOEIC, so guess on everything you can't reach. Pick a single 'letter of the day' for pure guesses to save seconds." },
    ],
  },
  {
    ...
    category: "Strategy",
    readTime: "4 min",
    summary: "A concrete pacing plan for the 75-minute Reading section, where most test-takers lose points simply by running out of clock.",
    sections: [
      { heading: "Why pacing matters", body: "Listening is externally paced — the audio moves you along. Reading is self-paced, and that's where scores leak. Most people spend too long on Part 5 grammar and never finish Part 7, leaving easy points unanswered." },
      { heading: "A target split for 75 minutes", points: [
  ...
  },
  {
    ...
    category: "Strategy",
    readTime: "4 min",
    summary: "How the 10–990 scale works, the CEFR levels it maps to, and the thresholds employers tend to care about.",
    sections: [
      { heading: "How the scale works", body: "TOEIC Listening & Reading is scored from 10 to 990, combining two section scores of 5–495 each. It's a scaled score, not a percentage — your raw correct count is converted using a formula that adjusts for form difficulty, so two test versions stay comparable." },
      { heading: "Approximate CEFR mapping", points: [
      ...
      { heading: "Thresholds employers commonly use", points: [
  ...
  },
  {
    ...
    category: "Strategy",
    readTime: "5 min",
    summary: "The recurring tricks the TOEIC uses to separate score bands — sound-alikes, word echoes, partial truths, and tense mismatches.",
    sections: [
      { heading: "Sound-alike distractors", body: "Especially in Listening Parts 1–2, wrong options use words that sound like the audio but mean something different (work/walk, copy/coffee, fund/found). Hearing a familiar sound is not the same as hearing the answer." },
      { heading: "Word-repetition traps", body: "If an answer option repeats a distinctive word you just heard or read, be suspicious. Correct answers usually paraphrase rather than echo." },
      { heading: "Partially-true options", body: "In Reading Part 7, an option may be true according to the passage but not answer the question asked. Re-read the question stem before committing." },
      { heading: "Tense and voice mismatches", points: [
      ...
      { heading: "Over-thinking yes/no questions", body: "In Part 2, indirect answers are correct more often at higher difficulty. 'Can you finish by Friday?' → 'I'll have to check my schedule' is a complete, correct answer." },
    ],
  },
  {
    ...
    readTime: "6 min",
    summary: "A task-by-task guide to the separate Speaking & Writing test, what raters reward, and templates that keep you on time.",
    sections: [
      { heading: "How it's structured", body: "Speaking & Writing is a separate test from Listening & Reading. Speaking has 11 tasks in about 20 minutes; Writing has 8 tasks in about 60 minutes. Each is scored 0–200, and they're often reported together as a 0–400 total." },
      { heading: "Speaking — what raters reward", points: [
      ...
      { heading: "Writing — what raters reward", points: [
      ...
      { heading: "A reusable opinion template", body: "Intro: restate the question and state your position. Body 1: first reason + concrete example. Body 2: second reason + concrete example. Conclusion: restate position in new words. Memorize this shape so you spend test time on content, not structure." },
    ],
  },
  {
    slug: "four-week-plan",
    ...
    category: "Strategy",
    readTime: "5 min",
    summary: "A realistic week-by-week plan to lift your score in a month, assuming about an hour a day.",
    sections: [
      { heading: "Week 1 — Diagnose and learn the format", points: [
      ...
      { heading: "Week 2 — Attack listening", points: [
      ...
      { heading: "Week 3 — Attack reading and pacing", points: [
      ...
      { heading: "Week 4 — Simulate and refine", points: [
